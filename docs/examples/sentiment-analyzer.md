...
3. Copy and paste the script from [`src/sentimentAnalyzer.js`](https://github.com/nirholas/XActions/blob/main/src/sentimentAnalyzer.js)
...
Copy the entire script from [`src/sentimentAnalyzer.js`](https://github.com/nirholas/XActions/blob/main/src/sentimentAnalyzer.js) and paste it into the console.
...
| File | Description |
|------|-------------|
| [`src/sentimentAnalyzer.js`](https://github.com/nirholas/XActions/blob/main/src/sentimentAnalyzer.js) | Main script |
