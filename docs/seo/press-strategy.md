...
This is also a prerequisite for a Wikipedia article (which requires 3+ independent reliable sources).

---

## Content Strategy: Create Shareable Assets

Before pitching press, create content that journalists and bloggers naturally want to cover.

### High-Coverage-Potential Angles

| Angle | Why It Works | Target Publications |
|-------|-------------|-------------------|
| "Free alternative to Twitter's $100/mo API" | Cost-saving, anti-big-tech narrative | TechCrunch, The Verge, Hacker News |
| "MCP server lets AI agents control Twitter" | AI trend, novel capability | AI newsletters, dev blogs |
| "Open-source tool lets you mass unfollow on Twitter" | Practical, high-search-volume problem | How-to blogs, YouTube tutorials |
| "Browser automation replaces expensive APIs" | Technical innovation angle | JavaScript Weekly, Node Weekly |
| "One developer built a complete Twitter toolkit" | Indie hacker / builder story | Indie Hackers, r/SideProject |
| "Why I open-sourced my Twitter automation tool" | Philosophy + technical story | Dev.to, Hashnode, freeCodeCamp |
...
| Platform | Title | Target Keywords |
|----------|-------|-----------------|
...
- Publish on your blog first, then cross-post to Dev.to/Hashnode 3 days later
- Each platform gets a slightly different intro paragraph

---

## Tier 2: Independent Coverage (Target Actively)

These count as independent reliable sources for Wikipedia and Knowledge Panel eligibility.

### Developer Newsletters

| Newsletter | Subscribers | Submission URL | Angle |
|-----------|------------|----------------|-------|
| **JavaScript Weekly** | 200k+ | https://cooperpress.com/submit | New JS tool / library |
| **Node Weekly** | 60k+ | https://cooperpress.com/submit | Node.js automation toolkit |
| **Console.dev** | 50k+ | https://console.dev/submit | New dev tool |
| **TLDR** | 1M+ | https://tldr.tech/sponsor | Interesting open-source project |
| **Changelog** | 500k+ | https://changelog.com/submit | Open-source news |
| **Hacker Newsletter** | 60k+ | Curated from HN front page | Hit HN first |
| **AI Tool Report** | 500k+ | Direct outreach | MCP server for Twitter |
| **Ben's Bites** | 100k+ | https://bensbites.beehiiv.com/ | AI agent tools |
| **Bytes** | 200k+ | https://ui.dev/bytes/submit | JS ecosystem tool |

### Tech Publications

| Publication | How to Pitch | Contact |
|-------------|-------------|---------|
...
| **James Q Quick** | 200k+ | Developer tools reviews |
| **Theo** | 500k+ | Hot takes on dev tools |

---

## Tier 3: Community-Generated Coverage

Encourage organic coverage through:
...
- **r/selfhosted** — Self-hosted Twitter automation

### Podcast Guest Appearances
- **The Changelog** — Open source story
- **JS Party** — JavaScript tooling
- **Software Engineering Daily** — Architecture deep-dive
- **Indie Hackers Podcast** — Builder story
...
- Profile/tweet/follower scraping
- MCP server for AI agents (Claude, GPT-4)
...
```
Subject: Video idea — Free Twitter automation without the API

Hey [Creator Name],

I built an open-source toolkit that does everything Twitter's $100/mo API does —
for free. It runs in the browser console or Node.js.
...
Demo: [link to 60-second demo video]
GitHub: https://github.com/nirholas/XActions
...
| Source | Type | Status | Date | URL |
|--------|------|--------|------|-----|
| Dev.to article | Self-published | [ ] Draft | | |
| Hashnode article | Self-published | [ ] Draft | | |
| Medium article | Self-published | [ ] Draft | | |
| JavaScript Weekly | Newsletter | [ ] Submitted | | |
| Node Weekly | Newsletter | [ ] Submitted | | |
| Console.dev | Newsletter | [ ] Submitted | | |
| Hacker News | Community | [ ] Posted | | |
| Product Hunt | Community | [ ] Launched | | |
| r/programming | Community | [ ] Posted | | |
| First YouTube mention | Independent | [ ] Waiting | | |
| First blog review | Independent | [ ] Waiting | | |
