...
3. Copy and paste the script from [`src/engagementManager.js`](https://github.com/nirholas/XActions/blob/main/src/engagementManager.js)
...
Copy the entire script from [`src/engagementManager.js`](https://github.com/nirholas/XActions/blob/main/src/engagementManager.js) and paste it into the console.
...
| File | Description |
|------|-------------|
| [`src/engagementManager.js`](https://github.com/nirholas/XActions/blob/main/src/engagementManager.js) | Main script |
