...
Comprehensive health check for your X/Twitter account. Generates a composite health score (0-100) across engagement, growth, content quality, and risk factors.
...
3. Copy and paste the script from [`src/accountHealthMonitor.js`](https://github.com/nirholas/XActions/blob/main/src/accountHealthMonitor.js)
...
|---------|---------|-------------|
| `postsToAnalyze` | `50` | posts To Analyze |
| `scrollDelay` | `1500` | scroll Delay |
| `maxScrolls` | `30` | max Scrolls |
...
Copy the entire script from [`src/accountHealthMonitor.js`](https://github.com/nirholas/XActions/blob/main/src/accountHealthMonitor.js) and paste it into the console.
...
| File | Description |
|------|-------------|
| [`src/accountHealthMonitor.js`](https://github.com/nirholas/XActions/blob/main/src/accountHealthMonitor.js) | Main script |
