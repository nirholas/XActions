...
100% Apache 2.0 licensed. Would love feedback on the architecture, especially the plugin system and workflow engine.
...
No Twitter API key needed. Apache 2.0 licensed.
...
💰 **100% free** — no API keys, no subscriptions, no paywalls. Apache 2.0 licensed.
